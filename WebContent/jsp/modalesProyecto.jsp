	      ...
	      <div class="modal-body">
	      		<form id="createNivelForm" class="form-content">
					...
					<input id="idNivel" type="hidden" name="id" />
		      		...
		      		<div class="form-row">
		      			<div class="form-group col-md-6">
						    <input class="form-control js-text" id="descripcion-nivel" type="text" name="descripcion" placeholder="DescripciÛn"  maxlength="200"/>
		      			</div>	      			
		      		</div>
		      		<div class="form-row">
		      			<div class="form-group col-md-6">
					...
					<div class="form-row">
		    			<div class="form-group col-md-12">
						    <div class="msg-exito" id="msg-exito-nivel">
						   			Se guardÛ el nivel exitosamente.
			     			</div>
		    			</div>
					</div>
	      ...
	      <div class="modal-body">
	      		<div class="form-row">
		      		<div class="form-group col-md-6" style="width: 100%;">
						  <span class="confirm">ø Est&aacute; seguro que desea eliminar el nivel?</span>						    
      				</div>	      			
	    		</div>		      		
				<div class="form-style-button proyecto">
	      		...
	      		<form id="metradoForm" class="form-content">
					...
					<div class="form-group col-md-12">
				    	<div class="msg-exito" id="msg-exito-metrado">
				   			Se guardÛ la configuraciÛn del metrado exitosamente.
			     			</div>
		    			</div>
					</div> 
...
// si esta el boton guardar mostrar mensaje seguro que desea salir ??
	...
	$(".js-text").on('keypress', function (e) {
		var regex = new RegExp("^([·ÈÌÛ˙Òaa-z¡…Õ”⁄ÒA-Z0-9 ]|\\.|\\,|\\(|\\)|\\_|\\-)$");
		if(!regex.test(e.key)) {
			return false;
		}
	});	
