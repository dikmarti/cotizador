    ...
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Ficha T&eacute;nica</h3>
  		...
  		<form id="createProjectForm" class="form-content">
    		...
    		<div class="form-row">
    			...
    			<div class="form-group col-md-4">
		    		<input class="form-control js-decimal" id="montoInversion" type="text" name="montoInversion" placeholder="Monto de inversiÛn" maxlength="200"/>
    			</div>
    		</div>
    		<div class="form-row">
    			<div class="form-group col-md-4">
    			...
    			<div class="form-group col-md-4">
				    <input class="form-control js-decimal" id="areaConstruccion" type="text" name="areaConstruccion" placeholder="¡rea de construccion" maxlength="200"/>
    			</div>
    		</div>
    		<div class="form-row">
    			<div class="form-group col-md-4">
		    	...
		    	<div class="form-group col-md-4">
				   <select class="form-control form-control-sm custom-color" id="garantia" name="garantia" >
				    	<option class="placeholder-option" value="" disabled selected >GarantÌa</option>
    		...
    		<div class="form-row">
    			<div class="form-group col-md-4">
				    <input class="form-control js-text" id="categoriaConstruccion" type="text" name="categoriaConstruccion" placeholder="Categoria de ConstrucciÛn" maxlength="200"/>
    			</div>
    			<div class="form-group col-md-4">
